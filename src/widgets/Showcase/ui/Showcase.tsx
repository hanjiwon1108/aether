          ...
          {projects.map((project, index) => {
            return (
              <motion.div
                ...
                className="relative h-[60vh] md:h-[70vh] w-[85vw] md:w-[45vw] min-w-[320px] md:min-w-[500px] rounded-3xl overflow-hidden group shadow-2xl shadow-primary/10 border border-white/10 [perspective:1000px] flex-shrink-0 cursor-pointer"
              >
                <motion.div
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-80 transition-opacity duration-500 flex flex-col justify-end p-10 md:p-14"
                >
                  <motion.div
