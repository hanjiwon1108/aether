      ...
      <div className="sticky top-0 flex h-screen items-center overflow-hidden">
        <motion.div style={{ x }} className="flex gap-8 md:gap-10 px-4 md:px-10">
          ...
          {projects.map((project, index) => (
            <div key={index} className="relative h-[50vh] md:h-[60vh] w-[80vw] md:w-[40vw] min-w-[300px] md:min-w-[400px] rounded-2xl overflow-hidden group border border-white/10">
              <Image
                src={project.image}
                alt={project.title}
                fill
